...
(* OASIS_START *)
(* DO NOT EDIT (digest: cb845d66c4a68cf0aa5708cf2fde33b6) *)
(*
...
let setup_t =
  {
     ...
     doc = [("ulib", OCamlbuildDocPlugin.doc_build ".")];
     ...
     clean_doc = [("ulib", OCamlbuildDocPlugin.doc_clean ".")];
     distclean = [];
     distclean_test =
       [
          ("test",
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_install_dir = "$htmldir/ulib";
                      doc_title = "API reference for ulib";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "s\239,\226\179\131\222\238x\221}\218\003\2084\128";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
